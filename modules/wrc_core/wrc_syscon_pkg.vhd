...
package sysc_wbgen2_pkg is
  ...
  type t_sysc_in_registers is record
    ...
    gpsr_pll_lock_i                          : std_logic;
    gpsr_pll_status_i                        : std_logic;
  ...
  constant c_sysc_in_registers_init_value: t_sysc_in_registers := (
    ...
    type t_sysc_out_registers is record
      ...
      gpsr_pll_wr_mode0_o                      : std_logic;
      gpsr_pll_wr_mode1_o                      : std_logic;
      ...
      gpcr_pll_wr_mode0_o                      : std_logic;
      gpcr_pll_wr_mode1_o                      : std_logic;
    ...
    constant c_sysc_out_registers_init_value: t_sysc_out_registers := (
      ...
      gpsr_pll_wr_mode0_o => '0',
      gpsr_pll_wr_mode1_o => '0',
      gpcr_led_stat_o => '0',
      gpcr_led_link_o => '0',
      gpcr_fmc_scl_o => '0',
      gpcr_fmc_sda_o => '0',
      ...
      gpcr_pll_wr_mode0_o => '0',
      gpcr_pll_wr_mode1_o => '0',
      tcr_enable_o => '0',
...
tmp.gpsr_pll_lock_i := f_x_to_zero(left.gpsr_pll_lock_i) or f_x_to_zero(right.gpsr_pll_lock_i);
tmp.gpsr_pll_status_i := f_x_to_zero(left.gpsr_pll_status_i) or f_x_to_zero(right.gpsr_pll_status_i);
