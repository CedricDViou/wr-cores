...
package sysc_wbgen2_pkg is
  ...
  type t_sysc_in_registers is record
    ...
    gpsr_dp_sfp_det_i                        : std_logic;
    gpsr_dp_sfp_scl_i                        : std_logic;
    gpsr_dp_sfp_sda_i                        : std_logic;
  ...
  constant c_sysc_in_registers_init_value: t_sysc_in_registers := (
    ...
    type t_sysc_out_registers is record
      ...
      gpsr_dp_led_stat_o                       : std_logic;
      gpsr_dp_led_link_o                       : std_logic;
      gpsr_dp_sfp_scl_o                        : std_logic;
      gpsr_dp_sfp_scl_load_o                   : std_logic;
      gpsr_dp_sfp_sda_o                        : std_logic;
      gpsr_dp_sfp_sda_load_o                   : std_logic;
      gpsr_minic_rst_o                         : std_logic;
      gpsr_minic_dp_rst_o                      : std_logic;
      ...
      gpcr_dp_led_stat_o                       : std_logic;
      gpcr_dp_led_link_o                       : std_logic;
      gpcr_dp_sfp_scl_o                        : std_logic;
      gpcr_dp_sfp_sda_o                        : std_logic;
    ...
    constant c_sysc_out_registers_init_value: t_sysc_out_registers := (
      ...
      gpsr_dp_led_stat_o => '0',
      gpsr_dp_led_link_o => '0',
      gpsr_dp_sfp_scl_o => '0',
      gpsr_dp_sfp_scl_load_o => '0',
      gpsr_dp_sfp_sda_o => '0',
      gpsr_dp_sfp_sda_load_o => '0',
      gpsr_minic_rst_o => '0',
      gpsr_minic_dp_rst_o => '0',
      gpcr_led_stat_o => '0',
      gpcr_led_link_o => '0',
      gpcr_fmc_scl_o => '0',
      gpcr_fmc_sda_o => '0',
      ...
      gpcr_spi_cs_o => '0',
      gpcr_spi_mosi_o => '0',
      gpcr_dp_led_stat_o => '0',
      gpcr_dp_led_link_o => '0',
      gpcr_dp_sfp_scl_o => '0',
      gpcr_dp_sfp_sda_o => '0',
      tcr_enable_o => '0',
...
tmp.gpsr_dp_sfp_det_i := f_x_to_zero(left.gpsr_dp_sfp_det_i) or f_x_to_zero(right.gpsr_dp_sfp_det_i);
tmp.gpsr_dp_sfp_scl_i := f_x_to_zero(left.gpsr_dp_sfp_scl_i) or f_x_to_zero(right.gpsr_dp_sfp_scl_i);
tmp.gpsr_dp_sfp_sda_i := f_x_to_zero(left.gpsr_dp_sfp_sda_i) or f_x_to_zero(right.gpsr_dp_sfp_sda_i);
