...
package sysc_wbgen2_pkg is
  ...
  type t_sysc_in_registers is record
    ...
    gpsr_sfp3_det_i                          : std_logic;
    gpsr_sfp3_scl_i                          : std_logic;
    gpsr_sfp3_sda_i                          : std_logic;
  ...
  constant c_sysc_in_registers_init_value: t_sysc_in_registers := (
    ...
    type t_sysc_out_registers is record
      ...
      gpsr_sfp3_scl_o                          : std_logic;
      gpsr_sfp3_scl_load_o                     : std_logic;
      gpsr_sfp3_sda_o                          : std_logic;
      gpsr_sfp3_sda_load_o                     : std_logic;
      ...
      gpcr_sfp3_scl_o                          : std_logic;
      gpcr_sfp3_sda_o                          : std_logic;
    ...
    constant c_sysc_out_registers_init_value: t_sysc_out_registers := (
      ...
      gpsr_sfp3_scl_o => '0',
      gpsr_sfp3_scl_load_o => '0',
      gpsr_sfp3_sda_o => '0',
      gpsr_sfp3_sda_load_o => '0',
      gpcr_led_stat_o => '0',
      gpcr_led_link_o => '0',
      gpcr_fmc_scl_o => '0',
      gpcr_fmc_sda_o => '0',
...
tmp.gpsr_sfp3_det_i := f_x_to_zero(left.gpsr_sfp3_det_i) or f_x_to_zero(right.gpsr_sfp3_det_i);
tmp.gpsr_sfp3_scl_i := f_x_to_zero(left.gpsr_sfp3_scl_i) or f_x_to_zero(right.gpsr_sfp3_scl_i);
tmp.gpsr_sfp3_sda_i := f_x_to_zero(left.gpsr_sfp3_sda_i) or f_x_to_zero(right.gpsr_sfp3_sda_i);
