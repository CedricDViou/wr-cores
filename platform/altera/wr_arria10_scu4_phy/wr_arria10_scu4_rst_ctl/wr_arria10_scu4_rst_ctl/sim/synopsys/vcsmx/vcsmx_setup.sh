...
if [ $SKIP_COM -eq 0 ]; then
  vlogan +v2k -sverilog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/../altera_xcvr_reset_control_181/sim/altera_xcvr_functions.sv"     -work wr_arria10_scu4_rst_ctl_altera_xcvr_reset_control_181
  vlogan +v2k -sverilog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/../altera_xcvr_reset_control_181/sim/alt_xcvr_resync.sv"           -work wr_arria10_scu4_rst_ctl_altera_xcvr_reset_control_181
  vlogan +v2k -sverilog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/../altera_xcvr_reset_control_181/sim/altera_xcvr_reset_control.sv" -work wr_arria10_scu4_rst_ctl_altera_xcvr_reset_control_181
  vlogan +v2k -sverilog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/../altera_xcvr_reset_control_181/sim/alt_xcvr_reset_counter.sv"    -work wr_arria10_scu4_rst_ctl_altera_xcvr_reset_control_181
  vlogan +v2k $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS           "$QSYS_SIMDIR/wr_arria10_scu4_rst_ctl.v"                                                                                                    
fi
