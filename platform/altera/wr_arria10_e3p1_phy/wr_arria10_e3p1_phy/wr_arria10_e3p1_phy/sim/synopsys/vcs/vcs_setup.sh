...
vcs -lca -timescale=1ps/1ps -sverilog +verilog2001ext+.v -ntb_opts dtm $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS \
  ...
  $QSYS_SIMDIR/../altera_xcvr_native_a10_181/sim/wr_arria10_e3p1_phy_altera_xcvr_native_a10_181_t6fhkiq.sv \
  $QSYS_SIMDIR/../altera_xcvr_native_a10_181/sim/alt_xcvr_native_rcfg_opt_logic_t6fhkiq.sv \
  $QSYS_SIMDIR/wr_arria10_e3p1_phy.v \
  -top $TOP_LEVEL_NAME
# ----------------------------------------
# simulate
